        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Edit Data Device</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Edit Data Device</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" id="nama_device"
                                                    name="nama_device" value="{{ $devices->nama_device }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" id="min_suhu"
                                                    name="min_suhu" value="{{ $devices->min_suhu }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" id="max_suhu"
                                                    name="max_suhu" value="{{ $devices->max_suhu }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" id="mac_address"
                                                    name="mac_address" value="{{ $devices->mac_address }}" required>
                                            </div>
                                        </div>
