        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Edit Data Roles</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Edit Data Roles</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" id="nama_role"
                                                    name="nama_role" value="{{ $roles->nama_role }}" required>
                                            </div>
                                        </div>

                                        <div class="col-xl-4 col-md-6 col-12">
                                            <a href="{{ route('roles.index') }}" class="btn btn-secondary mt-2">Back</a>
                                            <button class="btn btn-primary mt-2" type="submit">Edit Data Roles</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
