...
<div class="app-content content ">
    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Edit Data Setting Kode Kontrol</h2>
                    </div>
                </div>
            </div>
        ...
        <div class="content-body">
            <form action="{{ route('settingkodekontrol.update', $setting_kode_kontrols->id) }}" method="POST"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Edit Data Setiing Kode Kontrol</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            ...
                                            <button class="btn btn-primary mt-2" type="submit">Edit Data Setting Kode
                                                Kontrol</button>
                                        </div>
                                    </div>
                                </div>
